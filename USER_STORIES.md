...
- [x] `models.providers.openai.models` lists all LiteLLM models (Ollama first, then cloud)
- [x] Default primary model is Ollama local (lowest latency/cost); cloud models available as fallback
